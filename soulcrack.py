...
bot = telebot.TeleBot('7735389947:AAGC3Yp0b7mCxySTtePEMqbkmrH93q5bpEY')

# Admin user IDs
admin_id = {"5951082609", "5951082609", "5951082609"}
...
def handle_soul(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = " ミ🥹★ 𝘈𝘤𝘤𝘦𝘴𝘴 𝘭𝘦 𝘭𝘦 𝘣𝘳𝘰 ★🥹彡DM - @CYBERWAVE80."
